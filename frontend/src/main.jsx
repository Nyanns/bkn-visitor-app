...
console.log(
  `%c
      ...
      |  BKN VISITOR APP  |
       \\__________________/
  `,
  'color: #39c5bb; font-size: 14px; font-family: monospace;'
);
...
console.log(
  ...
  ╚═══════════════════════════════════════════════════════════════╝
  `,
  'color: #39c5bb; font-weight: bold; font-size: 11px; background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 15px; border-radius: 8px; text-shadow: 0 0 10px #39c5bb;'
);
